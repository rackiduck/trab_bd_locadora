...
class CategoriaFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_indexes' => [
            'FK_FilmeCategoria' => ['type' => 'index', 'columns' => ['filme_identificador'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['identificador_categoria'], 'length' => []],
            'FK_FilmeCategoria' => ['type' => 'foreign', 'columns' => ['filme_identificador'], 'references' => ['filme', 'filme_identificador'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
